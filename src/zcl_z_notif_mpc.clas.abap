class ZCL_Z_NOTIF_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_NOTIFICATION_IH,
     QMNUM type QMNUM,
     NOTIF_TYPE type QMART,
     FUNCT_LOC type TPLNR,
     SHORT_TEXT type QMTXT,
     PRIOKX type PRIOKX,
  end of TS_NOTIFICATION_IH .
  types:
TT_NOTIFICATION_IH type standard table of TS_NOTIFICATION_IH .
  types:
  ...
  types:
TT_IFLMT type standard table of TS_IFLMT .
  types:
     TS_T356_T type T356_T .
  types:
TT_T356_T type standard table of TS_T356_T .

  constants GC_IFLMT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Iflmt' ##NO_TEXT.
  constants GC_NOTIFICATION_IH type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'notification_ih' ##NO_TEXT.
  constants GC_T356_T type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'T356_T' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_NOTIF_MPC===============CP' ##NO_TEXT.

  methods DEFINE_NOTIFICATION_IH
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_IFLMT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_T356_T
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_Z_NOTIF_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_NOTIF_SRV' ).

define_notification_ih( ).
define_iflmt( ).
define_t356_t( ).
  endmethod.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Iflmt' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_NOTIF_MPC=>TS_IFLMT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'IflmtSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - notification_ih
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'notification_ih' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'NotifNumber' iv_abap_fieldname = 'QMNUM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_NOTIF_MPC=>TS_NOTIFICATION_IH' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'notificationSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'T356_T' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'T356_T'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'T356_TSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200513085627'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'NotifNumber'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'notification_ih'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '005'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'NotifType'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'notification_ih'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Iflmt'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
